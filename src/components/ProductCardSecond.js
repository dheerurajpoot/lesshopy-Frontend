...
const ProductCardSecond = () => {
  return (
    <>
      <div class="product-card-second relative m-2 md:w-full lg:w-full max-w-xs overflow-hidden rounded-lg bg-white shadow-2xl">
            <div>
                <Link>
          ...
          <Link>
            <img class="md:h-40 lg:h-50 xl:h-60 rounded-t-lg object-cover md:ml-7 lg:ml-7" src="images/tab3.jpg" alt="product 2" />
          </Link>
