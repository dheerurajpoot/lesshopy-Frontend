...
const SignUp = () => {
  return (
    <>
      <MetaTitle title ={"Sign Up to Lesshopy"}/>
        ...
        <div class="flex flex-col items-center justify-center my-20">
            ...
            <div class="w-full bg-white rounded-lg shadowr md:mt-0 sm:max-w-md xl:p-0">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    <h1 class="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl">Create your account</h1>
                    <form class="space-y-4 md:space-y-6" action="#">
                        <div>
                            <label for="email" class="block mb-2 text-sm font-medium text-gray-900">Full Name</label>
                            <input type="name" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Enter Full Name" required=""/>
                        </div>
                        <div>
                        ...
                        <button type="submit" class="w-full text-white bg-[#FF504E] hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Sign Up</button>
                        <p class="text-sm font-light text-gray-500">
                            have an account? <Link to='/login' class="font-medium text-primary-600 text-[#FF504E] hover:underline">Log In</Link>
                        </p>
                    </form>
                </div>
            </div>
