  ...
  return (
    <>
      ...
      <section className='py-50 mt-10 flex flex-col justify-center items-center'>
          ...
          <section class="bg-white my-10" id="contact">
              <div class="mx-auto max-w-7xl p-10">
                  <div class="mb-4">
                      <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                          ...
                          <p class="mx-auto mt-4 max-w-3xl text-xl">CONTACT US FOR ANY QUESTIONS
                          </p>
                      </div>
                  </div>
                  <div class="flex items-stretch justify-center">
                      <div class="grid md:grid-cols-2">
                          <div class="h-full pr-6">
                              ...
                              If you have question and query regarding to our app and If you have any problem during your order then contact us on given number :
                              </p>
                              <ul class="mb-6 md:mb-0">
                                  <li class="flex">
                                      ...
                                      <div class="ml-4 mb-4">
                                          ...
                                          <p>Purana Shivli Road Kalyanpur</p>
                                          <p >Kanpur Nagar, Uttar Pradesh, 208017</p>
                                      </div>
                                  </li>
                                  <li class="flex">
                                      <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                                      ...
                                      <div class="ml-4 mb-4">
                                          ...
                                          <p>Mobile: +91 9026315148</p>
                                          <p>Mail: contact@lesshopy.com</p>
                                      </div>
                                  </li>
                                  <li class="flex">
                                      <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                          ...
                          <div class="card h-fit max-w-6xl p-5 md:p-12" id="form">
                              ...
                              <form id="contactForm">
                                  ...
                                  <div class="text-center">
                                      <button type="submit" class="w-full bg-[#ff504e] text-white px-6 py-3 font-xl rounded-md sm:mb-0">Send Message</button>
                                  </div>
                              </form>
                          </div>
                      </div>
