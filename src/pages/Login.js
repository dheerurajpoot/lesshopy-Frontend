...
const Login = () => {
  return (
    <>
      <MetaTitle title ={"Log In to Lesshopy"}/>
        ...
        <div class="flex flex-col items-center justify-center my-20">
            ...
            <div class="w-full bg-white rounded-lg shadowr md:mt-0 sm:max-w-md xl:p-0">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    <h1 class="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl">Log in to your account</h1>
                    <form class="space-y-4 md:space-y-6" action="#">
                        ...
                        <p class="text-sm font-light text-gray-500">
                            Don’t have an account yet? <Link to='/Signup' class="font-medium text-primary-600 text-[#FF504E] hover:underline">Sign up</Link>
                        </p>
                    </form>
                </div>
            </div>
