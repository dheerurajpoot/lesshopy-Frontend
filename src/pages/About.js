...
const About = () => {
  return (
    <>
      <MetaTitle title ={"About - Lesshopy"}/>
      <section className='mx-auto max-w-7xl p-10 bg-white my-10'>
        <div class="max-w-6xl py-4 mx-auto lg:py-6 md:px-6">
            <div class="flex flex-wrap ">
                <div class="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 ">
                    <div class="lg:max-w-md">
                        ...
                        <div class="flex flex-wrap items-center">
                            <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6 shadow">
                            ...
                            <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6 shadow">
                                <div class="p-6 bg-white">
                                    <span class="text-blue-500">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class=" w-10 h-10 bi bi-people-fill" viewBox="0 0 16 16">
                                            <path
                                    ...
                                    <h2 class="text-sm text-gray-700">Happy Customers</h2>
                                </div>
                            </div>
                            <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6 shadow">
                                <div class="p-6 bg-white">
                                    <span class="text-blue-500">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class=" w-10 h-10 bi bi-person-fill" viewBox="0 0 16 16">
                                            <path
                            ...
                            <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6 shadow">
                                <div class="p-6 bg-white">
                                    <span class="text-blue-500">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class=" w-10 h-10 bi bi-alarm-fill" viewBox="0 0 16 16">
                                            <path
                ...
                <div class="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                    <img src="https://i.postimg.cc/9MW8G96J/pexels-the-coach-space-2977565.jpg" alt="" class="relative z-40 object-cover w-full h-full rounded"/>
                </div>
            </div>
        </div>
      </section>
